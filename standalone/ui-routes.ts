...
export type UiRoute =
  | { readonly kind: "unlock" | "invoices" | "invoice-new" | "proformas" | "proforma-new" | "customers" | "products" | "settings" }
...
const staticRoutes: Readonly<Record<string, Extract<UiRoute, { kind: string }>["kind"]>> = {
  "/unlock": "unlock", "/invoices": "invoices", "/invoices/new": "invoice-new", "/proformas": "proformas", "/proformas/new": "proforma-new",
