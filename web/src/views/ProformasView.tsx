...
export const ProformasView = () => {
  ...
  return <Page title="Proforme" eyebrow="Documente comerciale" actions={<ButtonLink href="/proformas/new">Proformă nouă</ButtonLink>}>
    {proformas.error === null ? null : <ErrorAlert error={proformas.error} />}
    <section className="card">
      <div className="section-heading"><div><h2>Registru de proforme</h2><p>Creează și urmărește documentele comerciale nefiscale.</p></div><span className="count">{items.length}</span></div>
