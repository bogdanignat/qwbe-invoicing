...
export const ProductPresetsView = ({ notify }: { readonly notify: (message: string) => void }) => {
  ...
  const items = presets
  return <Page title="Produse și servicii" eyebrow="Preseturi facturare" actions={<a className="button primary" href="/invoices/new">Factură nouă</a>}>
