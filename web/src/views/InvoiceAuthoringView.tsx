...
import {
  authoringAccess, authoringDocumentPayload, authoringReadiness, authoringSeriesOptions, createDraftPayload, documentNotesIssue, documentNotesMaxLength, draftLinePayload, draftLinesForEditing, formFromDraft, headerMatchesDraft, newAuthoringForm, pendingLineOperations, updateDraftPayload,
...
const AuthoringSession = ({ initialDraft, issuer, customers, invoiceSeries, proformaSeries, unitOfMeasures, backgroundErrors, notify }: AuthoringSessionProps) => {
  ...
  const notesIssue = documentNotesIssue(form.notes)
