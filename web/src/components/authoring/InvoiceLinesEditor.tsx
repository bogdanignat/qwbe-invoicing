...
import type { ProductPreset, VatRate, UnitOfMeasure } from "../../lib/models.ts"
...
export const InvoiceLinesEditor = ({ lines, productPresets, vatRates, unitOfMeasures, pending, onAdd, onChange, onApplyPreset, onDelete }: InvoiceLinesEditorProps) => {
