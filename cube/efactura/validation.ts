...
const checkParties = (document: EFacturaDocument, issues: Array<string>): void => {
  ...
  if (document.seller.vatIdentifier === null && document.seller.taxRegistrationIdentifier === null) {
  ...
  if (document.buyer.vatIdentifier === null && document.buyer.legalRegistrationIdentifier === null) {
